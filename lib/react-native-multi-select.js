...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    styleItemsContainerParent: ViewPropTypes.style,
  ...
  _getRowContent = item => {
    return (
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        {this._getRowText(item)}
        {this._getRowSelected(item)}
      </View>
    );
  };
          ...
          >
            ...
            <View
              style={[
                ...
                styleItemsContainerParent && styleItemsContainerParent
              ]}
            >
